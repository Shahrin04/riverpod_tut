...
import 'package:riverpod_tut/data/cart_state_notifier.dart';
...
class StateNotifierPage extends ConsumerWidget {
  ...
  showBox(BuildContext context, List<ProductModel> cartNotifier, WidgetRef ref){
    showDialog(context: context, builder: (context){
      return AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...cartNotifier.map((e) => Text(e.title)),
            const SizedBox(height: 10,),
            Text('Total: ${cartNotifier.fold<double>(0, (sum, item) => sum + item.price)}',
        ...
        actions: [
          Stack(
            children: [
              IconButton(
                  onPressed: (){
                    showBox(context, cartNotifier.toList(), ref);
                  },
              ...
              Positioned(
                  ...
                  child: Container(
                    ...
                    child: Text('${cartNotifier.length.toString()}', style: TextStyle(fontSize: 12), textAlign: TextAlign.center,),
                  ))
            ],
          )
        ],
